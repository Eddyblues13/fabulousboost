              ...
              <div className="p-6 space-y-6">
                ...
                {(selectedTicket.replies || []).length > 0 && (
                  <div className="space-y-4">
                    ...
                    {selectedTicket.replies.map((reply) => (
                      <div key={reply.id} className={`rounded-lg p-4 border-l-4 ${reply.is_internal ? 'bg-yellow-50 border-yellow-400' : reply.admin_id ? 'bg-blue-50 border-blue-600' : 'bg-gray-50 border-gray-400'}`}>
                        <div className="flex items-center gap-2 mb-2">
                ...
                <div className="border-t border-gray-200 pt-6">
                  ...
                  <button
                    ...
                    className="mt-4 w-full px-6 py-3 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isReplying ? (
                      <>
