...
const ShowOrders = () => {
  ...
  const getStatusColor = (status) => {
    ...
    if (statusLower.includes("partial")) return "bg-blue-100 text-blue-800"
    if (statusLower.includes("refunded")) return "bg-purple-100 text-purple-800"
        ...
        <div className="mt-4 pt-4 border-t border-gray-200 space-y-3">
          ...
          {hasValue(order.status_description) && (
            <div>
              ...
              <p className="text-sm bg-blue-50 p-2 rounded text-blue-700">{order.status_description}</p>
            </div>
          )}
  ...
  const DesktopTableRow = ({ order }) => (
    <div className={`grid grid-cols-12 gap-4 px-6 py-4 items-center text-sm border-b border-gray-100 hover:bg-gray-50 transition-colors ${expandedOrder === order.id ? "bg-blue-50" : ""}`}>
          ...
          <>
            ...
            <div className="hidden lg:block bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="min-w-full">
                <div className="grid grid-cols-12 gap-4 px-6 py-4 text-white font-semibold text-sm bg-gradient-to-r from-purple-600 to-indigo-700">
        ...
        <div className="p-6 space-y-6">
          ...
          {hasValue(order.status_description) && (
            <div className="pt-4 border-t border-gray-200">
              ...
              <div className="bg-blue-50 p-3 rounded text-blue-700 border border-blue-200">{order.status_description}</div>
            </div>
          )}
          {hasValue(order.reason) && (
            <div className="pt-4 border-t border-gray-200">
