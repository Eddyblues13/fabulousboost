    ...
    <div className="p-4 md:p-6 lg:p-8 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6 items-center">
        <div className="relative flex-1 w-full md:w-auto">
          ...
          <Input
            ...
            className="pl-10 pr-4 py-2 border rounded-md w-full focus-visible:ring-blue-500"
            value={searchTerm}
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <div className="relative">
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              <SelectTrigger className="w-full md:w-[180px] focus:ring-blue-500">{statusFilter}</SelectTrigger>
              <SelectContent>
      ...
      {showMobileFilters && (
        <div className="md:hidden bg-gray-50 p-3 rounded-md mb-4">
          ...
          <div className="relative">
            <Select value={statusFilter} onValueChange={setStatusFilter} className="w-full focus:ring-blue-500">
