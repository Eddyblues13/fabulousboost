    ...
    <div>
      <section className="py-20 px-4 sm:px-6 lg:px-12 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          <div className="text-purple-600 text-lg font-semibold mb-2">We Accept</div>
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            ...
            transfers to card payments and even cryptocurrency, we have got you covered wherever you are in
            the world.
          </p>
          <div className="mt-10">
            <img
