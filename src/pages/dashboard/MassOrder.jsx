      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-6 text-white">
            ...
            <p className="text-purple-100 mt-1">Follow this exact format for each order line</p>
          </div>
          
          <div className="p-6 space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-purple-500">
              <div className="flex items-center justify-between mb-2">
                <code className="text-lg font-mono font-semibold text-purple-700">service_id | link | quantity</code>
                <button
                  onClick={copyFormat}
                  className="px-3 py-1.5 border border-purple-200 rounded-md text-purple-600 hover:bg-purple-50 flex items-center transition-colors duration-200"
                >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <button
                  onClick={loadExample}
                  className="mt-3 px-3 py-1.5 border border-purple-200 rounded-md text-purple-600 hover:bg-purple-50 flex items-center transition-colors duration-200"
                >
            ...
            <div className="space-y-4">
              <div className="relative">
                <textarea
                  ...
                  className="w-full min-h-[300px] p-4 font-mono text-sm border-2 border-purple-200 focus:border-purple-500 rounded-md resize-none transition-colors duration-200"
                />
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 h-12 px-4 py-2 text-lg font-semibold bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-md shadow-lg disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center transition-all duration-200 hover:shadow-xl"
                >
                  {isSubmitting ? (
                    <>
