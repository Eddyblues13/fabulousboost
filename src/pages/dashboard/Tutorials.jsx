...
function Tutorials() {
  const tutorials = [
    {
      id: 1,
      title: "How to use Smexploits.com",
      ...
      thumbnail: "/images/tutorial-how-to-use.png", // Placeholder image
    },
    {
      id: 2,
      title: "How to fund your Smexploits account",
      description: "Learn the various methods to securely add funds to your wallet.",
      youtubeId: "dQw4w9WgXcQ", // Placeholder YouTube ID
      thumbnail: "/images/tutorial-how-to-fund.png", // Placeholder image
    },
    {
      id: 3,
      ...
      youtubeId: "dQw4w9WgXcQ", // Placeholder YouTube ID
      thumbnail: "/images/tutorial-refill.png", // Placeholder image
    },
    {
      id: 4,
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-base lg:text-lg text-text-medium max-w-2xl mx-auto">
            Need help using Smexploits? Our tutorials cover everything from funding your wallet to placing your first
