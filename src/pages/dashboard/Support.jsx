...
const Support = () => {
  ...
  const faqItems = [
    {
      id: "why-choose",
      question: "Why choose Fabulousboost.com?",
      answer:
        "Fabulousboost makes social media growth simple and affordable. We offer a wide range of services, fast delivery, real-time order tracking, and friendly support. Whether you're a beginner or a reseller, we've got what you need to succeed.",
    },
    {
      id: "beginner-friendly",
      question: "Is Fabulousboost.com beginner friendly?",
      answer:
    ...
    {
      id: "reseller-program",
      question: "Can I resell Fabulousboost.com services?",
      answer:
    ...
    {
      id: "support-types",
      question: "What kind of support does Fabulousboost.com offer?",
      answer:
 ...
 const handleSubmit = async (e) => {
  ...
  const getStatusBadge = (status) => {
    const badges = {
      ...
      2: { text: 'In Progress', class: 'bg-purple-100 text-purple-700' },
        ...
        <div className="w-full p-4 space-y-6">
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              At Fabulousboost, we understand what works and what doesn't in digital marketing. Our team is here to help
              ...
              {(selectedTicket.replies || []).length > 0 && (
                <div className="space-y-4">
                  ...
                  {selectedTicket.replies.map((reply) => (
                    <div key={reply.id} className={`rounded-lg p-4 ${reply.admin_id ? 'bg-purple-50 border-l-4 border-purple-600' : 'bg-gray-50'}`}>
                      <div className="flex items-center gap-2 mb-2">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-semibold ${reply.admin_id ? 'bg-green-600' : 'bg-purple-600'}`}>
