      ...
      <div className="min-h-screen bg-gray-50 p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <button 
            ...
            className="mt-4 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-md transition-all duration-200"
          >
            Retry
          </button>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 h-11 px-4 py-2 border-2 border-purple-200 focus:border-purple-500 rounded-md transition-colors duration-200"
              />
            </div>
            <div className="flex gap-3">
              <select
                ...
                className="w-48 h-11 px-4 py-2 border-2 border-purple-200 focus:border-purple-500 rounded-md transition-colors duration-200"
              >
              ...
              <select
                ...
                className="w-40 h-11 px-4 py-2 border-2 border-purple-200 focus:border-purple-500 rounded-md transition-colors duration-200"
              >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all duration-200 ${
                selectedCategory === "all"
                  ...
                  : "bg-transparent border border-gray-300 text-gray-700 hover:bg-purple-50"
              }`}
            >
        ...
        {newServices.length > 0 && (
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-6">
              ...
              <p className="text-purple-100">Latest additions to our service catalog</p>
            </div>
                    ...
                    <tr key={service.id} className="border-b hover:bg-gray-50">
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-purple-600">{service.id}</span>
                        </div>
                      </td>
                      <td className="py-3 px-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {service.description && (
                              <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded-full text-xs line-clamp-1">
                      ...
                      <td className="py-3 px-4">
                        <button className="w-full px-3 py-1.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-md text-sm transition-all duration-200">
                          View
                        </button>
                      </td>
                    </tr>
