      ...
      <div className="p-2">
        ...
        {searchResults.slice(0, 25).map((service) => (
          <div
            ...
            className="p-3 hover:bg-purple-50 rounded-lg cursor-pointer transition-all duration-200 border-b border-gray-100 last:border-b-0 group"
          >
            <div className="flex items-start justify-between">
              <div className="flex-1 min-w-0">
                ...
                <h4 className="font-medium text-gray-800 text-sm sm:text-base mb-1 group-hover:text-purple-600 truncate flex items-center gap-2">
              ...
              <div className="text-xs text-purple-500 font-medium opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0 ml-2">
                Select →
              </div>
            </div>
          </div>
  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        onBlur={onSearchBlur}
        className={`w-full ${isMobile ? 'pl-10 pr-4 py-3.5 text-base' : 'pl-12 pr-4 py-4 text-lg'} border border-purple-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 bg-white hover:border-purple-300 max-w-full`}
      />
